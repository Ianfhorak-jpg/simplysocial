 ...
 *
 * ── Seit Phase 19f steht hier KEIN Gruppen-Knopf mehr ────────────────────────
 * Er stand seit Phase 18d gleich unter der Kopfkarte, weil Leopold ihn ganz unten
 * nicht gefunden hatte. Ians Entscheidung 56 verlegt ihn in die Kopfzeile des
 * Chats-Registers: *„das hat eigentlich nix mit dem Profil zu tun, sondern eher mit
 * dem Chatten."* Das Profil ist ein Aushang — was man darauf sieht, sieht Lea auch,
 * und WELCHE Gruppen jemand hat, gehört ohnehin nicht dorthin (`Profil.tsx` hält es
 * auf fremden Profilen schon immer zurück).
 *
